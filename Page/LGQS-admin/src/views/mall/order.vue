<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="配送单号" prop="shipSn" />

      <el-table-column align="center" label="配送方式" prop="shipChannel" />
    ...
    <el-dialog :visible.sync="orderDialogVisible" title="订单详情" width="800">
      <section ref="print">
        <el-form :data="orderDetail" label-position="left">
          ...
          <el-form-item label="餐品信息">
            <el-table :data="orderDetail.orderGoods" border fit highlight-current-row>
              <el-table-column align="center" label="餐品名称" prop="goodsName" />
              <el-table-column align="center" label="餐品编号" prop="goodsSn" />
              <el-table-column align="center" label="餐品规格" prop="specifications" />
              <el-table-column align="center" label="餐品价格" prop="price" />
              <el-table-column align="center" label="餐品数量" prop="number" />
              <el-table-column align="center" label="餐品图片" prop="picUrl">
                <template slot-scope="scope">
          ...
          <el-form-item label="费用信息">
            <span>
              ...
              (餐品总价){{ orderDetail.order.goodsPrice }}元 +
              (配送费用){{ orderDetail.order.freightPrice }}元 -
          ...
          <el-form-item label="配送信息">
            <span>（配送方式）{{ orderDetail.order.shipChannel }}</span>
            <span>（配送单号）{{ orderDetail.order.shipSn }}</span>
            <span>（配送时间）{{ orderDetail.order.shipTime }}</span>
          </el-form-item>
    ...
    <el-dialog :visible.sync="payDialogVisible" title="订单收款" width="40%" center>
      ...
      <el-table :data="payForm.goodsList">
        <el-table-column property="goodsName" label="餐品" />
    ...
    <el-dialog :visible.sync="shipDialogVisible" title="发货">
      <el-form ref="shipForm" :model="shipForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        <el-form-item label="配送方式" prop="shipChannel">
        ...
        <el-form-item label="配送编号" prop="shipSn">
