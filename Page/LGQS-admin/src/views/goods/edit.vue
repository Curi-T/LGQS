  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        <el-table-column property="value" label="餐品规格">
          <template slot-scope="scope">
        ...
        <el-table-column property="price" label="餐品售价" />
        <el-table-column property="number" label="餐品数量" />
        <el-table-column property="url" label="餐品图片">
          <template slot-scope="scope">
      ...
      <el-dialog :visible.sync="productVisiable" title="编辑餐品">
        <el-form ref="productForm" :model="productForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
          <el-form-item label="餐品规格列" prop="specifications">
            <el-tag v-for="tag in productForm.specifications" :key="tag">
              {{ tag }}
            </el-tag>
          </el-form-item>
          <el-form-item label="餐品售价" prop="price">
            <el-input v-model="productForm.price" />
          </el-form-item>
          <el-form-item label="餐品数量" prop="number">
            <el-input v-model="productForm.number" />
          </el-form-item>
          <el-form-item label="餐品图片" prop="url">
            <el-upload
              :headers="headers"
              :action="uploadPath"
              :show-file-list="false"
    ...
    <div class="op-container">
      ...
      <el-button type="primary" @click="handleEdit">更新餐品</el-button>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      attributes: [],
      rules: {
        name: [{ required: true, message: '餐品名称不能为空', trigger: 'blur' }]
      },
      editorInit: {
        language: 'zh_CN',
        height: '400px',
