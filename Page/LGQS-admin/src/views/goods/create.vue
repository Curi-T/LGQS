  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="products">
        ...
        <el-table-column property="price" width="100" label="餐品售价" />
        <el-table-column property="number" width="100" label="餐品数量" />
        <el-table-column property="url" width="100" label="餐品图片">
          <template slot-scope="scope">
      ...
      <el-dialog :visible.sync="productVisiable" title="添加餐品">
        <el-form
          ref="productForm"
          :model="productForm"
          status-icon
...
export default {
  ...
  data() {
    return {
      ...
      attributes: [],
      rules: {
        goodsSn: [{ required: true, message: '餐品编号不能为空', trigger: 'blur' }],
