<template>
  <div class="app-container">
    ...
    <el-form ref="topic" :rules="rules" :model="topic" status-icon label-position="left" label-width="100px" style="width: 800px; margin-left:50px;">
      ...
      <el-form-item label="餐品低价" prop="price">
        <el-input v-model="topic.price"/>
      </el-form-item>
      <el-form-item label="阅读量" prop="readCount">
        <el-input v-model="topic.readCount"/>
      </el-form-item>
      <el-form-item label="专题餐品" prop="goods">
        <el-button style="float:right;" size="mini" type="primary" @click="handleCreate()">创建餐品</el-button>
        ...
        <el-table :data="goodsList" border fit highlight-current-row>
          ...
          <el-table-column align="center" label="餐品名称" prop="name"/>
          <el-table-column align="center" label="餐品介绍" prop="brief"/>
    ...
    <el-dialog :visible.sync="addVisiable" title="添加餐品">
      <div class="search">
        <el-input v-model="listQuery.goodsSn" clearable class="filter-item" style="width: 200px;" placeholder="请输入餐品编号"/>
        <el-input v-model="listQuery.name" clearable class="filter-item" style="width: 200px;" placeholder="请输入餐品名称"/>
